...
# s_0=(1-exp(s_1)-exp(s_2));
# n_0=(1-exp(n_1)-exp(n_2));

# s_0p=(1-exp(s_1(+1))-exp(s_2(+1)));
# n_0p=(1-exp(n_1(+1))-exp(n_2(+1)));
 
# n_0m=(1-exp(n_1(-1))-exp(n_2(-1)));
...
exp(c_0)=exp(a_0)*n_0^(1-alf)*q_0^(1-alf)*s_0^alf*exp(k(-1))^alf-i;
