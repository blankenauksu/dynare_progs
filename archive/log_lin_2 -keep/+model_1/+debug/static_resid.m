...
lhs(2) = T(12)*T(19);
rhs(2) = T(31);
lhs(3) = T(10)*T(20)*T(25);
rhs(3) = T(32);
lhs(4) = T(12)*T(20)*T(27);
rhs(4) = T(32);
lhs(5) = params(4)*(T(30)/(1-params(10)*T(28))+T(23)/T(13));
rhs(5) = 1/(1-params(10)*T(28));
lhs(6) = T(13);
rhs(6) = y(9)+T(13)*(1-params(8))-T(13)*T(29);
lhs(7) = exp(y(6));
rhs(7) = T(20)*T(33)*T(34)-y(9);
lhs(8) = exp(y(7));
rhs(8) = T(20)*T(35)*T(36);
lhs(9) = exp(y(8));
rhs(9) = T(20)*T(37)*T(38);
lhs(10) = y(10);
rhs(10) = y(10)*params(14)+x(1);
lhs(11) = y(11);
rhs(11) = y(11)*params(15)+x(2);
lhs(12) = y(12);
rhs(12) = y(12)*params(16)+x(3);
end
