...
g1 = zeros(10, 10);
g1(1,1)=T(10)*(1-params(3))*exp(params(11))*(-(exp(y(1))*exp(y(3))*T(13)))/(exp(y(1))*exp(y(1)))*T(39)-T(41);
g1(1,2)=(-T(47));
g1(1,3)=T(10)*(1-params(3))*exp(params(11))*T(16)*T(39)-T(52);
g1(1,4)=(-T(56));
g1(1,5)=T(10)*(1-params(3))*exp(params(11))*T(16)*T(39)-T(8)*exp(y(10))*(1-params(3))*T(14)*T(40);
g1(1,6)=T(17)*T(9)*T(62)-T(64);
g1(1,7)=T(17)*T(66)-T(15)*T(7)*T(65);
g1(1,8)=T(17)*T(9)*T(67)-T(15)*T(7)*T(67);
g1(1,10)=(-T(31));
g1(2,1)=(-T(41));
g1(2,2)=T(12)*(1-params(3))*exp(params(12))*(-(exp(y(2))*exp(y(4))*T(13)))/(exp(y(2))*exp(y(2)))*T(48)-T(47);
g1(2,3)=(-T(52));
g1(2,4)=T(12)*(1-params(3))*exp(params(12))*T(18)*T(48)-T(56);
g1(2,5)=T(12)*(1-params(3))*exp(params(12))*T(18)*T(48)-T(8)*exp(y(10))*(1-params(3))*T(14)*T(40);
g1(2,6)=T(19)*T(11)*T(62)-T(64);
g1(2,7)=T(19)*T(11)*T(65)-T(15)*T(7)*T(65);
g1(2,8)=T(19)*T(68)-T(15)*T(7)*T(67);
g1(2,10)=(-T(31));
g1(3,1)=T(10)*T(20)*params(3)*exp(params(11))*T(24)*T(42)-T(45);
g1(3,2)=(-T(50));
g1(3,3)=T(10)*T(20)*params(3)*exp(params(11))*T(42)*(-(exp(y(3))*exp(y(1))))/(exp(y(3))*exp(y(3)))-T(54);
g1(3,4)=(-T(58));
...
g1(3,10)=(-T(32));
g1(4,1)=(-T(45));
g1(4,2)=T(12)*T(20)*params(3)*exp(params(12))*T(26)*T(51)-T(50);
g1(4,3)=(-T(54));
g1(4,4)=T(12)*T(20)*params(3)*exp(params(12))*T(51)*(-(exp(y(4))*exp(y(2))))/(exp(y(4))*exp(y(4)))-T(58);
...
g1(8,1)=(-(T(20)*T(35)*exp(params(11))*exp(y(1))*getPowerDeriv(exp(y(1)),1-params(3),1)));
g1(8,3)=(-(T(20)*T(36)*exp(y(3))*getPowerDeriv(exp(y(3)),params(3),1)));
g1(8,5)=(-(T(35)*T(36)*T(59)));
g1(8,7)=exp(y(7));
g1(9,2)=(-(T(20)*T(37)*exp(params(12))*exp(y(2))*getPowerDeriv(exp(y(2)),1-params(3),1)));
