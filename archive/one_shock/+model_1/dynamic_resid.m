...
residual = zeros(10, 1);
    ...
    residual(6) = (T(33)) - (y(13)+exp(y(3))*(1-params(8))-T(49));
    residual(7) = (exp(y(10))) - (T(36)*T(55)*T(54)*T(99)-y(13));
    residual(8) = (exp(y(11))) - (T(36)*T(51)*T(50)*T(56));
    residual(9) = (exp(y(12))) - (T(36)*T(53)*T(52)*T(57));
    residual(10) = (y(14)) - (params(14)*y(4)+x(it_, 1));
