...
T(70) = exp(y(22))*(1-params(3))*(T(69)/T(65))^params(3);
T(71) = T(31)/T(21);
T(72) = (1-params(3))*exp(y(23))*T(71)^params(3);
T(73) = T(32)/T(24);
T(74) = (1-params(3))*exp(y(24))*T(73)^params(3);
T(75) = (1-exp(y(27))-exp(y(28)))*T(33)/T(3);
T(76) = (1-params(3))*exp(y(34))*(T(75)/T(68))^params(3);
T(77) = T(34)/T(27);
...
T(88) = params(3)*exp(y(34))*(T(68)*T(87))^(1-params(3));
...
lhs(6) = T(33);
rhs(6) = y(21)+exp(y(5))*(1-params(8))-T(49);
lhs(7) = exp(y(18));
rhs(7) = T(36)*T(55)*T(54)*T(99)-y(21);
lhs(8) = exp(y(19));
...
lhs(11) = y(23);
rhs(11) = params(15)*y(11)+x(2);
lhs(12) = y(24);
rhs(12) = params(16)*y(12)+x(3);
end
