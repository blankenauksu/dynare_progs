...
g1(1,6)=T(11)*params(3)*exp(y(9))*y(2)*(T(7)*T(20)+T(3)*params(6)*getPowerDeriv(y(6),T(4),1))-y(2)*exp(y(8))*y(1)*params(3)*T(11)*T(5)*T(20)/y(1);
...
g1(2,7)=T(11)*params(3)*exp(y(10))*y(3)*(T(9)*T(21)+T(3)*params(7)*getPowerDeriv(y(7),T(4),1))-y(3)*exp(y(8))*y(1)*params(3)*T(11)*T(5)*T(21)/y(1);
g1(2,8)=(-(y(3)*T(12)));
...
g1(4,3)=(-1);
g1(5,1)=(-(exp(y(8))*T(13)));
g1(5,4)=(-(1-params(8)+exp(y(8))*y(1)*T(16)-1));
g1(5,5)=1;
