...
residual=NaN(11, 1);
  ...
  T(31)=params(10)/2*(y(14)/y(7)-params(8))^2;
  T(32)=1-params(8)-T(31)+(y(14)/y(7)-params(8))*params(10)*y(14)/y(7);
  residual(5)=(params(4)*(T(26)/y(7)+T(32)/T(30)))-(1/T(30));
  residual(6)=(y(7))-(y(14)+y(7)*(1-params(8))-y(7)*T(31));
  residual(7)=(1)-(y(3)+y(1)+y(2));
  residual(8)=(1)-(y(6)+y(4)+y(5));
  T(33)=T(7)*y(1)^(1-params(3));
  T(34)=y(4)^params(3);
  residual(9)=(y(11))-(T(9)*T(33)*T(34)-y(14));
...
if nargout > 3
    g1_v = NaN(57, 1);
g1_v(1)=T(16)*T(9)*(1-params(3))*T(11)*T(44)*1/y(2)+T(13)*T(6)*params(3)*T(11)*T(45)*y(7)*1/y(2);
g1_v(2)=T(6)*T(9)*params(3)*T(11)*T(46)*(-y(2))/(y(5)*y(5));
g1_v(3)=(-1);
g1_v(4)=(-(T(9)*T(35)*getPowerDeriv(y(5),params(3),1)));
g1_v(5)=T(50);
g1_v(6)=T(50);
...
g1_v(12)=T(16)*T(9)*(1-params(3))*T(11)*(-y(5))/(y(2)*y(2))*T(44)+T(13)*T(6)*params(3)*T(11)*y(7)*(-y(5))/(y(2)*y(2))*T(45);
g1_v(13)=T(6)*T(9)*params(3)*T(11)*1/y(5)*T(46);
g1_v(14)=(-1);
g1_v(15)=(-(T(9)*T(36)*T(11)*getPowerDeriv(y(2),1-params(3),1)));
g1_v(16)=T(42);
g1_v(17)=T(42);
...
g1_v(27)=params(4)*((y(7)*T(25)*T(51)-T(26))/(y(7)*y(7))+(T(30)*(params(10)*y(14)/y(7)*(-y(14))/(y(7)*y(7))+(y(14)/y(7)-params(8))*(-(params(10)*y(14)))/(y(7)*y(7))-params(10)/2*(-y(14))/(y(7)*y(7))*2*(y(14)/y(7)-params(8)))-T(32)*(-(params(10)*(-y(14))/(y(7)*y(7)))))/(T(30)*T(30)))-params(10)*(-y(14))/(y(7)*y(7))/(T(30)*T(30));
g1_v(28)=1-(1-params(8)-(T(31)+y(7)*params(10)/2*(-y(14))/(y(7)*y(7))*2*(y(14)/y(7)-params(8))));
g1_v(29)=(-(T(33)*T(34)*T(51)));
g1_v(30)=(-(T(35)*T(36)*T(51)));
g1_v(31)=(-(T(39)*T(51)));
g1_v(32)=params(4)*(T(30)*(params(10)*y(14)/y(7)*1/y(7)+(y(14)/y(7)-params(8))*params(10)/y(7)-params(10)/2*2*(y(14)/y(7)-params(8))*1/y(7))-T(32)*(-(params(10)*1/y(7))))/(T(30)*T(30))-params(10)*1/y(7)/(T(30)*T(30));
g1_v(33)=(-(1-y(7)*params(10)/2*2*(y(14)/y(7)-params(8))*1/y(7)));
g1_v(34)=1;
g1_v(35)=T(24)*T(9)*(1-params(3))*T(21)*(-y(6))/(y(3)*y(3))*T(47)+T(9)*T(22)*T(20)*params(3)*T(21)*y(7)*(-y(6))/(y(3)*y(3))*T(48);
g1_v(36)=T(20)*T(9)*params(3)*T(21)*1/y(6)*T(49);
g1_v(37)=(-1);
g1_v(38)=(-(T(9)*T(38)*T(21)*getPowerDeriv(y(3),1-params(3),1)));
g1_v(39)=T(24)*T(9)*(1-params(3))*T(21)*T(47)*1/y(3)+T(9)*T(22)*T(20)*params(3)*T(21)*T(48)*y(7)*1/y(3);
g1_v(40)=T(20)*T(9)*params(3)*T(21)*T(49)*(-y(3))/(y(6)*y(6));
g1_v(41)=(-1);
g1_v(42)=(-(T(9)*T(37)*getPowerDeriv(y(6),params(3),1)));
g1_v(43)=T(13)*T(15)*T(5)*T(53)-T(55);
g1_v(44)=T(9)*T(22)*T(23)*T(19)*T(53)-T(55);
g1_v(45)=T(9)*T(27)*T(5)*T(53)-T(26)*T(54);
g1_v(46)=T(9)*T(29)*T(19)*T(53)-T(26)*T(54);
g1_v(47)=1;
g1_v(48)=T(13)*T(15)*T(57)-T(10)*T(14)*T(3)*T(56);
g1_v(49)=T(9)*T(22)*T(23)*T(19)*T(56)-T(10)*T(14)*T(3)*T(56);
g1_v(50)=T(9)*T(27)*T(57)-T(26)*T(3)*T(56);
g1_v(51)=T(9)*T(29)*T(19)*T(56)-T(26)*T(3)*T(56);
g1_v(52)=1;
g1_v(53)=T(13)*T(15)*T(5)*T(58)-T(10)*T(14)*T(3)*T(58);
g1_v(54)=T(9)*T(22)*T(23)*T(59)-T(10)*T(14)*T(3)*T(58);
g1_v(55)=T(9)*T(27)*T(5)*T(58)-T(26)*T(3)*T(58);
g1_v(56)=T(9)*T(29)*T(59)-T(26)*T(3)*T(58);
g1_v(57)=1;
