...
lhs(6) = T(8)*T(14)*T(16);
rhs(6) = T(23);
lhs(7) = T(10)*T(14)*T(17);
rhs(7) = T(23);
lhs(8) = params(4)*(T(21)/T(19)+T(14)*T(15)*params(3)*exp(y(16))/y(7));
rhs(8) = 1/T(19);
lhs(9) = y(7);
rhs(9) = y(14)+y(7)*(1-params(8))-y(7)*T(20);
lhs(10) = 1;
rhs(10) = y(3)+y(1)+y(2);
lhs(11) = 1;
rhs(11) = y(6)+y(4)+y(5);
lhs(12) = y(11);
rhs(12) = T(14)*T(24)*T(25)-y(14);
lhs(13) = y(12);
rhs(13) = T(14)*T(26)*T(27);
lhs(14) = y(13);
rhs(14) = T(14)*T(28)*T(29);
lhs(15) = y(15);
rhs(15) = x(2);
lhs(16) = y(16);
rhs(16) = x(1);
