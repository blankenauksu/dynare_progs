...
oo_.exo_steady_state(1) = 1.2;
oo_.steady_state(2) = ((M_.params(3)+M_.params(4))/(M_.params(1)*M_.params(5)*1.2))^(1/(M_.params(1)-1));
oo_.steady_state(1) = oo_.steady_state(2)^M_.params(1)*M_.params(5)*1.2-M_.params(3)*oo_.steady_state(2);
oo_.steady_state(3)=oo_.exo_steady_state(1);
steady;
%
% SHOCKS instructions
...
struct('exo_det',false,'exo_id',1,'type','level','periods',20:200,'value',1.2) ];
M_.exo_det_length = 0;
...
save([M_.dname filesep 'Output' filesep 'model_simple_example_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_simple_example_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_simple_example_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_simple_example_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_simple_example_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_simple_example_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_simple_example_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_simple_example_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
