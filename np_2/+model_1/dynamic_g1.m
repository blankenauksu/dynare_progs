...
g1(1,10)=T(9)*params(3)*exp(y(13))*y(6)*(T(6)*T(24)+T(3)*params(7)*getPowerDeriv(y(10),T(4),1))-y(6)*exp(y(12))*y(5)*params(3)*T(9)*T(5)*T(24)/y(5);
...
g1(2,11)=T(9)*params(3)*exp(y(14))*y(7)*(T(7)*T(25)+T(3)*params(8)*getPowerDeriv(y(11),T(4),1))-y(7)*exp(y(12))*y(5)*params(3)*T(9)*T(5)*T(25)/y(5);
g1(2,12)=(-(y(7)*T(16)));
...
g1(3,16)=(-((-(T(12)*T(3)*params(6)*getPowerDeriv(y(16),T(4),1)))/(T(15)*T(15))));
...
g1(5,1)=(-(1-params(9)+exp(y(12))*y(5)*T(19)));
g1(5,8)=1;
g1(5,9)=1;
