...
M_.param_names(6) = {'om_0'};
M_.param_names_tex(6) = {'om\_0'};
M_.param_names_long(6) = {'om_0'};
M_.param_names(7) = {'om_1'};
M_.param_names_tex(7) = {'om\_1'};
M_.param_names_long(7) = {'om_1'};
M_.param_names(8) = {'om_2'};
M_.param_names_tex(8) = {'om\_2'};
M_.param_names_long(8) = {'om_2'};
M_.param_names(9) = {'delt'};
M_.param_names_tex(9) = {'delt'};
M_.param_names_long(9) = {'delt'};
M_.param_names(10) = {'var_a_0'};
M_.param_names_tex(10) = {'var\_a\_0'};
M_.param_names_long(10) = {'var_a_0'};
M_.param_names(11) = {'var_a_1'};
M_.param_names_tex(11) = {'var\_a\_1'};
M_.param_names_long(11) = {'var_a_1'};
M_.param_names(12) = {'var_a_2'};
M_.param_names_tex(12) = {'var\_a\_2'};
M_.param_names_long(12) = {'var_a_2'};
M_.param_names(13) = {'rho_a_0'};
M_.param_names_tex(13) = {'rho\_a\_0'};
M_.param_names_long(13) = {'rho_a_0'};
M_.param_names(14) = {'rho_a_1'};
M_.param_names_tex(14) = {'rho\_a\_1'};
M_.param_names_long(14) = {'rho_a_1'};
M_.param_names(15) = {'rho_a_2'};
M_.param_names_tex(15) = {'rho\_a\_2'};
M_.param_names_long(15) = {'rho_a_2'};
...
M_.block_structure.block(2).variable = [ 6 7 2 3 4 1 5];
...
M_.block_structure.block(2).g1_sparse_rowval = int32([1 2 3 4 5 1 3 4 7 2 3 4 7 1 3 6 2 4 6 5 7 3 4 5 6 3 4 5 7 7 7 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([5 5 5 5 5 8 8 8 8 9 9 9 9 10 10 10 11 11 11 12 12 13 13 13 13 14 14 14 14 20 21 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 1 1 1 1 6 6 6 10 14 17 20 22 26 30 30 30 30 30 30 31 32 ]);
M_.block_structure.variable_reordered = [ 8 9 10 6 7 2 3 4 1 5];
...
M_.block_structure_stat.block(4).variable = [ 2 1 6 7 5 3 4];
M_.block_structure_stat.variable_reordered = [ 8 9 10 2 1 6 7 5 3 4];
...
M_.block_structure_stat.block(4).g1_sparse_rowval = int32([1 3 5 1 2 5 6 7 3 5 6 4 5 6 2 5 6 1 4 6 2 3 4 5 6 7 ]);
...
delt = M_.params(9);
M_.params(10) = 0.5;
var_a_0 = M_.params(10);
M_.params(11) = 0.6;
var_a_1 = M_.params(11);
M_.params(12) = 0.7;
var_a_2 = M_.params(12);
M_.params(13) = 0.9;
rho_a_0 = M_.params(13);
M_.params(14) = 0.9;
rho_a_1 = M_.params(14);
M_.params(15) = 0.9;
rho_a_2 = M_.params(15);
%
% INITVAL instructions
%
options_.initval_file = false;
oo_.steady_state(1) = 0.2937912933205741;
oo_.steady_state(2) = 0.21525365988355666;
oo_.steady_state(3) = 0.4909550467958693;
oo_.steady_state(4) = 0.6382906961327719;
oo_.steady_state(5) = 0.1708898935773115;
oo_.steady_state(6) = 0.17197281546297563;
oo_.steady_state(7) = 0.3922391921647987;
