...
T(21) = params(5)*getPowerDeriv(y(15),T(1),1)*T(20);
T(22) = T(5)*T(21)+T(3)*params(5)*getPowerDeriv(y(15),T(4),1);
T(23) = exp(y(18))*y(11)*params(3)*T(9)*T(22)/y(11);
T(24) = T(20)*params(6)*getPowerDeriv(y(16),T(1),1);
T(25) = T(20)*params(7)*getPowerDeriv(y(17),T(1),1);
end
