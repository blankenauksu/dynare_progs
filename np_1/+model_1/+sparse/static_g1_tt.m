...
T(18) = params(5)*getPowerDeriv(y(5),T(1),1)*T(17);
T(19) = exp(y(8))*y(1)*params(3)*T(11)*(T(5)*T(18)+T(3)*params(5)*getPowerDeriv(y(5),T(4),1))/y(1);
T(20) = T(17)*params(6)*getPowerDeriv(y(6),T(1),1);
T(21) = T(17)*params(7)*getPowerDeriv(y(7),T(1),1);
end
