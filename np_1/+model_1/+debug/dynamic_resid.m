...
rhs(2) = y(13)*T(16);
lhs(3) = params(4)*(1+params(3)*exp(y(28))*y(21)*T(10)-params(9));
rhs(3) = T(12)/T(15);
lhs(4) = 1;
rhs(4) = y(13)+y(11)+y(12);
lhs(5) = y(15);
rhs(5) = exp(y(18))*y(11)*T(11)+y(4)*(1-params(9))-y(14);
lhs(6) = y(16);
rhs(6) = exp(y(19))*y(12)*T(11);
lhs(7) = y(17);
rhs(7) = exp(y(20))*y(13)*T(11);
lhs(8) = y(18);
rhs(8) = params(13)*y(8)+x(1);
lhs(9) = y(19);
rhs(9) = params(14)*y(9)+x(2);
lhs(10) = y(20);
rhs(10) = params(15)*y(10)+x(3);
end
