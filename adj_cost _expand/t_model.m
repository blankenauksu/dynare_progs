...
# p_0plus=om_0/om_0*(c_0(+1)/c_0(+1))^(-1/eps);
# p_1=om_1/om_0*(c_1/c_0)^(-1/eps);
# p_1plus=om_1/om_0*(c_1(+1)/c_0(+1))^(-1/eps);
# p_2=om_2/om_0*(c_2/c_0)^(-1/eps);
# p_2plus=om_2/om_0*(c_2(+1)/c_0(+1))^(-1/eps);


y=i+c_0*p_0+c_1*p_1+c_2*p_2;
# yplus=i(+1)+c_0(+1)*p_0plus+c_1(+1)*p_1plus+c_2(+1)*p_2plus;
r=1;

tot=(1/r(+1)*y(+1)-y)/y;

sc=(
(1/r(+1)*y_0(+1)*p_0plus/n_0(+1)-y_0*p_0/n_0)*n_0(+1)+
(1/r(+1)*c_1(+1)*p_1plus/n_1(+1)-c_1*p_1/n_1)*n_1(+1)+
(1/r(+1)*c_2(+1)*p_2plus/n_2(+1)-c_2*p_2/n_2)*n_2(+1))
/y;

win=(
(n_0(+1)-n_0)*y_0*p_0/n_0+
(n_1(+1)-n_1)*c_1*p_1/n_1+
(n_2(+1)-n_2)*c_2*p_2/n_2)
/y;
