...
[T_order, T] = model_permanent_shock.sparse.dynamic_resid_tt(y, x, params, steady_state, T_order, T);
T_order = 1;
if size(T, 1) < 125
...
T(81) = (-(T(73)*exp(y(32))*(1-params(3))*(-(y(21)*y(7)/y(18)*T(79)))/(T(16)*T(16))*T(80)+T(53)*T(46)*(T(79)-(params(9)*y(18)/y(1)*(-y(18))/(y(1)*y(1))+T(15)*(-(params(9)*y(18)))/(y(1)*y(1))))));
...
T(87) = (-(T(73)*exp(y(32))*(1-params(3))*T(80)*(T(16)*(-(y(21)*y(7)))/(y(18)*y(18))-y(21)*y(7)/y(18)*T(84))/(T(16)*T(16))+T(53)*T(46)*(T(84)-(params(9)*y(18)/y(1)*1/y(1)+T(15)*params(9)/y(1)))+T(74)*(1-params(3))*exp(y(49))*(-(y(38)*y(24)/y(35)*T(85)))/(T(21)*T(21))*T(86)+T(59)*T(49)*(T(26)*params(9)*(-y(35))/(y(18)*y(18))+params(9)*(y(35)/y(18)-1)*(-y(35))/(y(18)*y(18))*2*y(35)/y(18))));
T(88) = (-(T(46)*T(24)*exp(y(32))*params(3)*T(82)*(y(18)/y(21)*T(84)+T(16)*1/y(21))));
T(89) = getPowerDeriv(T(21)*y(35)/y(38),1-params(3),1);
T(90) = 1/y(18);
T(91) = (-(T(74)*(1-params(3))*exp(y(49))*T(86)*(T(21)*(-(y(38)*y(24)))/(y(35)*y(35))-y(38)*y(24)/y(35)*(-(T(14)*2*(y(35)/y(18)-1)*T(90))))/(T(21)*T(21))+T(59)*T(49)*(T(26)*params(9)*T(90)+params(9)*(y(35)/y(18)-1)*2*y(35)/y(18)*T(90))));
...
T(105) = 1/y(20);
T(106) = (-(T(73)*exp(y(32))*(1-params(3))*T(80)*y(7)/y(18)/T(16)));
T(107) = (-(T(46)*T(24)*exp(y(32))*params(3)*T(82)*T(16)*(-y(18))/(y(21)*y(21))));
T(108) = (-(T(74)*(1-params(3))*exp(y(49))*T(86)*y(24)/y(35)/T(21)));
T(109) = T(73)*exp(y(32))*(1-params(3))*T(80)*y(21)/y(18)/T(16);
T(110) = getPowerDeriv(y(7),params(3),1);
T(111) = T(74)*(1-params(3))*exp(y(49))*T(86)*y(38)/y(35)/T(21);
